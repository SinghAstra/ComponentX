...
The Dialog component supports intuitive keyboard interactions:

- **Cmd/Ctrl + {keyToMakeDialogVisible}** - Toggle dialog open/closed
- **Escape** - Close dialog
- **Click Outside** - Close dialog (click outside the modal)
