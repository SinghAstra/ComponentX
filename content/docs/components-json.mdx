...
import {
  MultiStepIconsExample,
  MultiStepIconsExampleCode,
} from "@/examples/multi-step-icons-example";
...
This is `new123 ComponentPreview`

<ComponentPreview
  code={MultiStepIconsExampleCode}
  component={<MultiStepIconsExample />}
/>
